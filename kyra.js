...
console.clear()
process.title = 'Cord Promo Checker - @kyra.dev'

function printCenteredRedAsciiArt() {
    const asciiArt = [
        '▄ •▄  ▄· ▄▌▄▄▄   ▄▄▄· ',
        '█▌▄▌▪▐█▪██▌▀▄ █·▐█ ▀█ ',
        '▐▀▀▄·▐█▌▐█▪▐▀▀▄ ▄█▀▀█ ',
    ...
    for (const line of asciiArt) {
        ...
        const paddedLine = ' '.repeat(padding > 0 ? padding : 0) + line;
        console.log(chalk.red(paddedLine));
    }
    console.log();
}
